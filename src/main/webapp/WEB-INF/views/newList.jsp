    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 text-center">
                <h1 id="fh5co-logo"><a href="new">LİSTEM</a></h1>
            </div>
...
<div class="container-fluid">
    <div class="row fh5co-post-entry single-entry">
        <article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
            ...
            <input class ="form form-control" type="text" id="list_name" style="height: 50px; width: 100%;" placeholder="Liste Adı...">
            ...
            <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
                <div class="row">
                    <div class="col-lg-8 cp-r animate-box">
                        <div class="fh5co-highlight right">
                            ...
                            <div id="myDIV" class="header">
                                <input type="text" id="myInput" placeholder="Ekle...">
                    ...
                    <div class="col-lg-4 animate-box">
                        <div class="fh5co-highlight right">
                            <button class="btn btn-info" style="width: 100%" onclick="newList()" id="updateBtn" >KAYDET</button>
                            <br/>   <br>
                            <button class="btn btn-danger" style="width: 100%" onclick="cancel()" >VAZGEÇ</button>
                        </div>
                    </div>
                </div>
...
<script src="list/custom/newList.js"></script>
